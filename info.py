...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "6858251193").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Heart_broker0"
)  # without @ or https://t.me/
USERNAME = environ.get("Fake_SmileK", "")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002255407902").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002076321803"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002076321803"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002332166273"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1003114836682"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003114836682"))
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002435214785"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1002421825139"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002076321803")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002076321803"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+LfMoLOc65BkyOThl")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+fLEYehyF2wtlMTVl")
...
SHORTENER_API = environ.get("SHORTENER_API", "625fc89708b390a43ebb9913af7e676de0bd5a66")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "clk.sh")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "625fc89708b390a43ebb9913af7e676de0bd5a66"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "clk.sh")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "625fc89708b390a43ebb9913af7e676de0bd5a66"
)
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "clk.sh")
