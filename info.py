...
GATE_API_URL = environ.get("GATE_API_URL", "https://web-production-d7533.up.railway.app")   # e.g. https://your-protection-bot.up.railway.app
GATE_API_KEY = environ.get("GATE_API_KEY", "chx_b6q_4NhibnhfuC4alq9nMayUN-Af4YyVfQ-XMEUJUQI")   # must match the protection bot's own GATE_API_KEY
...
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "dd3762c423556b4f906267ec7cd8ee9b28731d91"
)
